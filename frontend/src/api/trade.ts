...
export const orderApi = {
  ...
  cancel(orderId: number, reason?: string): Promise<Result<void>> {
    return http.put(`${BASE_URL}/${orderId}/cancel`, null, { params: { reason } })
  },
  ...
  applyRefund(orderId: number, reason: string): Promise<Result<void>> {
    return http.post(`${BASE_URL}/${orderId}/refund`, null, { params: { reason } })
  },
...
export const paymentApi = {
  ...
  createPayment(orderId: number, payType: string): Promise<Result<unknown>> {
    return http.post('/payment/create', null, { params: { orderId, payType } })
  },
  ...
  // 申请退款
  applyRefund(orderId: number, reason: string): Promise<Result<void>> {
    return http.post('/payment/refund', null, { params: { orderId, reason } })
  },
...
export const evaluationApi = {
  ...
  reply(evaluationId: number, content: string): Promise<Result<void>> {
    return http.post(`/evaluation/${evaluationId}/reply`, null, { params: { content } })
  },
...
export const disputeApi = {
  ...
  addEvidence(disputeId: number, evidenceUrl: string): Promise<Result<void>> {
    return http.post(`/dispute/${disputeId}/evidence`, null, { params: { evidenceUrl } })
  },
